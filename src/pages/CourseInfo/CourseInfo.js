...
console.log(datas);
  ...
  return (
    <div>
      ...
      <section class="course-info shadow p-3">
        <div class="container">
          <div class="row">
            <div class="col-6">
              ...
              <h1 class="course-info__title">{courseInfos.name}</h1>
              <p class="course-info__text">{courseInfos.description}</p>
              <div class="course-info__social-media">
                <a href="#" class="course-info__social-media-item">
                  <BsTelegram class="course-info__icon" />
                </a>
                <a href="#" class="course-info__social-media-item">
                  <BiLogoTwitter class="course-info__icon" />
                </a>
                <a href="#" class="course-info__social-media-item">
                  <BsFacebook class="course-info__icon" />
                </a>
              </div>
            </div>
              ...
              <div class="course">
                ...
                <div class="introduction">
                  ...
                  <div class="introduction__btns">
                    <a href="#" class="introduction__btns-item mx-3">
                ...
                <div class="techer-details">
                  <div class="techer-details__header">
                    ...
                    <div class="techer-details__header-left">
                      <FaChalkboardTeacher class="techer-details__header-icon" />
              ...
              <div class="courses-info">
                <div class="course-info">
                  <div class="course-info__register">
                    <span class="course-info__register-title">
                      {courseInfos.isUserRegisteredToThisCourse ? (
                        <>
                          <FaGraduationCap class="course-info__register-icon ms-3" />
                          دانشجو دوره هستید
                        </>
                      ) : (
                        <span
                  ...
                  <div class="course-info__total">
                    <div class="course-info__top">
                      <div class="course-info__total-sale">
                        <PiStudentBold class="course-info__total-sale-icon ms-3" />
                    ...
                    <div class="course-info__bottom">
                      <div class="course-info__total-comment">
                        <AiFillWechat class="course-info__total-comment-icon" />
                      ...
                      <div class="course-info__total-view">
                        <FaEye class="course-info__total-view-icon" />
                ...
                <div class="course-info">
                  <div class="course-info__header-short-url">
                    <FaLink class="course-info__short-url-icon" />
                ...
                <div class="course-info">
                  ...
                  {relatedCourses.map(course=>(
                    <li key={course._id} class="course-info__courses-list-item">
